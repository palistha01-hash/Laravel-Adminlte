<div id="backendModal" class="modal custom-modal fade" role="dialog" data-backdrop="static">
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document" id="moveableDialog">
        <div class="modal-content" id="resizeableContent">
            <div class="modal-header modal-drag-handle  position-relative">
                <h5 class="modal-title appOption-title text-center w-100 font-weight-bold fs-3">Edit Employee</h5>
            ...
            <div class="modal-footer d-flex justify-content-center">
                <div class="buttons d-flex submit-section">
                    <div class="btn-container pr-lg-3 pr-0 pb-3 pb-lg-0">
                        <button type="button"
                            class="btn cancel-modal-btn justify-content-center pq-reset-btn closeModal"
                            data-dismiss="modal" aria-label="Close">
                            Cancel
                        </button>
                    </div>
                    <div class="btn-container">
                        <button type="button" id="saveBtn" class="btn btn-primary submit-btn mb-2 mb-md-0">
                            Save
                        </button>
                    </div>
